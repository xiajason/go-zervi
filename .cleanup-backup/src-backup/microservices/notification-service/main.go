...
func main() {
	...
	// 注册到Consul
	registerToConsul("notification-service", "127.0.0.1", 8605)

	// 启动服务器
	log.Println("Starting Notification Service with jobfirst-core on 0.0.0.0:8605")
	if err := r.Run(":8605"); err != nil {
