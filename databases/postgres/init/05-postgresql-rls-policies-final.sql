-- PostgreSQL RLS (Row Level Security) 权限管理策略 - 最终版
-- 基于实际表结构实现行级安全控制
...
-- 简历黑名单表RLS策略 - 基于enterprise_id
CREATE POLICY resume_blacklist_enterprise_access ON resume_blacklist
    FOR ALL
